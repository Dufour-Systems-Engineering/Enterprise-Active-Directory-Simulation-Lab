...
| [**GPO Management Runbook**](./gpo-management-runbook.md) | Pre-flight checks, manual GUI (Sales), automated PowerShell rollout (Engineering), wallpaper/drive mapping/folder redirection | ✅ Complete | May 22, 2026 |
